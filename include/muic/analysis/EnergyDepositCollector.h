...
public:
    ...
    void onEventEnd();
    void setEtaBeforeNozzle(const unsigned int &track_id, const G4double &eta);
    void setEtaAfterNozzle(const unsigned int &track_id, const G4double &eta);
    void setPhiBeforeNozzle(const unsigned int &track_id, const G4double &phi);
    void setPhiAfterNozzle(const unsigned int &track_id, const G4double &phi);

    void addPhiScatter(const unsigned int& track_id, const G4double &);
    void addEtaScatter(const unsigned int& track_id, const G4double &);
    ...
    void setThetaBeforeNozzle (const unsigned int& track_id , const G4double &theta);
    void setThetaAfterNozzle(const unsigned int& track_id, const G4double &theta);
    ...
    void addThetaScatter(const unsigned int &track_id, const G4double &);
    void addPositionThetaScatter(const unsigned int &track_id, const G4double &);

public:
    std::map<unsigned int, double> eta_before_nozzle_collection_;
    std::map<unsigned int, double> eta_after_nozzle_collection_;
    std::map<unsigned int, double> phi_before_nozzle_collection_;
    std::map<unsigned int, double> phi_after_nozzle_collection_;
    std::map<unsigned int, double> phi_scatter_;
    std::map<unsigned int, double> before_nozzle_collection_;
    std::map<unsigned int, double> after_nozzle_collection_;
    std::map<unsigned int, double> energy_deposit_collection_;
    std::map<unsigned int, double> eta_scatter_;
    ...
    std::map<unsigned int, double> theta_before_nozzle_;
    std::map<unsigned int, double> theta_after_nozzle_;
    std::map<unsigned int, double> position_theta_before_nozzle_;
    std::map<unsigned int, double >position_theta_after_nozzle_;
    std::map<unsigned int, double>theta_scatter_;
